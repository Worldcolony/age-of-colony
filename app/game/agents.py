            ...
            "messages": [
                {
                    ...
                    "content": (
                        ...
                        "another role's evidence. game.colony.teamRouting is an analysis assignment, never "
                        "a loyalty rule: prioritize what the assigned team is likely to do, but vote against "
                        "that team whenever the ant's own evidence supports another outcome. Neutral routing "
                        "compares both teams evenly. dataReliability is a common factual quality check. When "
                        "game.rules.directionalVoteRequired is true, abstain is intentionally unavailable: "
                        "each ant must use its role evidence, objective and the reliable match context to choose "
                        "the strongest offered outcome, even when its evidence is neutral. Otherwise, an ant "
                        "must vote abstain when its own role evidence is missing or irrelevant to the current "
                        "market, or when the source is explicitly unreliable. There is no sentinel role. "
                        ...
                        "Use abstain only when it is present in game.market.availableVotes. "
