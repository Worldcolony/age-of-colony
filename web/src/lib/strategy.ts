...
export const STYLE_OPTIONS = [
  {
    ...
    description: "Enter only when every directional ant agrees.",
    thresholdPercent: 100,
    cadenceLabel: "Unanimous entries",
  },
  {
    value: "balanced",
    label: "Balanced",
    shortLabel: "Stay flexible",
    description: "Enter when four of five directional ants agree.",
    thresholdPercent: 80,
    cadenceLabel: "Strong-majority entries",
  },
  {
    value: "aggressive",
    label: "Aggressive",
    shortLabel: "Press the edge",
    description: "Enter on a simple three-of-five majority.",
    thresholdPercent: 60,
    cadenceLabel: "Majority entries",
  },
