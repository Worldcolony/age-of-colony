// Compact simplex noise (2D + 3D) — public-domain implementation
// adapted from Stefan Gustavson / Peter Eastman's reference code.
(function () {
  ...
  function Noise(seed) {
    const { perm, permMod12 } = buildPermutation(seed || 1);
    this.perm = perm;
    this.permMod12 = permMod12;
  }

  Noise.prototype.n2 = function (xin, yin) {
  ...
  Noise.prototype.n3 = function (xin, yin, zin) {
    const perm = this.perm, permMod12 = this.permMod12;
